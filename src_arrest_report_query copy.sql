...
FROM
	Reporting.Arrest Arrest
	INNER JOIN Reporting.ArrestEvent ArrestEvent
		ON Arrest.Id = ArrestEvent.Arrest_Id
	INNER JOIN Reporting.ArrestPerson ArrestPerson
		ON Arrest.Id = ArrestPerson.Arrest_Id
	INNER JOIN Reporting.ArrestCharge ArrestCharge
		ON Arrest.Id = ArrestCharge.Arrest_Id
	INNER JOIN Reporting.ArrestOfficer ArrestOfficer
